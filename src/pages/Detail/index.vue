        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr, index) in spuSaleAttrList" :key="spiSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuSaleAttrValue.isChecked == 1 }"
                  ...
                  @click="changeActive(spuSaleAttrValue)">{{ spuSaleAttrValue.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
  ...
  methods: {
    ...
    async addShopCart() {
      ...
      try {
        ...
        this.$route.push({name:'addcartsuccess',query:{skuNum:this.skuNum}})
      } catch (error) {
        alert(error.message)
      }
